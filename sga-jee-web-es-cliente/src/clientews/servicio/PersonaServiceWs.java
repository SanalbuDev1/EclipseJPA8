...
public interface PersonaServiceWs {
     ...
     * @param arg0
     * @return
     *     returns clientews.servicio.Persona
     */
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "listarPersonaUna", targetNamespace = "http://servicio.sga.gm.com.mx/", className = "clientews.servicio.ListarPersonaUna")
    @ResponseWrapper(localName = "listarPersonaUnaResponse", targetNamespace = "http://servicio.sga.gm.com.mx/", className = "clientews.servicio.ListarPersonaUnaResponse")
    @Action(input = "http://servicio.sga.gm.com.mx/PersonaServiceWs/listarPersonaUnaRequest", output = "http://servicio.sga.gm.com.mx/PersonaServiceWs/listarPersonaUnaResponse")
    public Persona listarPersonaUna(
